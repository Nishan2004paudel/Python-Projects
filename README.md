...
This repository contains a collection of small **Python projects** that I am building while exploring and learning Python.

These projects are part of my hands-on learning journey to strengthen core programming concepts, problem-solving skills, and practical implementation.

## Projects

### 1. Tic-Tac-Toe 🎮
A simple Tic-Tac-Toe game built using Python.  
This project helped me practice basic game logic, user interaction, and working with Python libraries for building interactive applications.
